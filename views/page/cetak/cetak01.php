<?php
if ($_SERVER['REQUEST_METHOD'] == 'GET' && empty($_GET['cari1']) && realpath(__FILE__) == realpath($_SERVER['SCRIPT_FILENAME'])) {
    /* 
...
$cari = $_GET['cari1'];
    ?>
        ...
        <div class="col-12 mt-4">
            <a href="cetakp01.php?cari1=<?= $cari ?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</a><br><br>
            <center>
            ...
            <table class="table table-bordered table-hover table-responsive">
                ...
                <tbody>
                    ...
                    $totalpoktan = 0;
                    $nomor = 1;
                    $qcari1 = "SELECT * FROM tbl_gratieks WHERE komodi = '$cari'";
